...
import atguigu.sources.CheckpointedTaxiFareSource;
 ...
 *
 */
public class ExpiringState extends ProjectBase {
    ...
    public static void main(String[] args) throws Exception {
        ...
        final String ridesFile = params.get("rides", ProjectBase.pathToRideData);
        final String faresFile = params.get("fares", ProjectBase.pathToFareData);
